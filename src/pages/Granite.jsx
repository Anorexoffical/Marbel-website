...
// Granite Collection Images - First batch (from granite folder)
...
export default function Granite() {
  ...
  // Granite data - updated with granite images (first batch from granite folder + second batch)
  const granites = [
    // First batch (granite root folder)
